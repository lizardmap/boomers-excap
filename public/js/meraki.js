...
var user_continue_url = decodeURIComponent(
  GetURLParameter("user_continue_url")
);
...
function login() {
  ...
  // Helper function to calculate over 13
  function ageOver13(age) {
    return age >= 13;
  }

  // Boolean guest over 13
  var guestOver13 = ageOver13(getAge(data.birthdate));
